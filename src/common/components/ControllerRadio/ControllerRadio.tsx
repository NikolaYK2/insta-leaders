...
import { RadioGroupComponent, RadioGroupPropsType } from '@nikolajk2/lib-insta-leaders'
...
export const ControllerRadio = <T extends FieldValues>({
  ...
  return (
    <RadioGroupComponent {...props} value={value} name={nameRadio} onValueChange={onChange}>
      {children}
    </RadioGroupComponent>
  )
}
