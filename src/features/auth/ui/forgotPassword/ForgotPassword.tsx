...
export const ForgotPassword: NextPageWithLayout = () => {
  ...
  const { handleSubmit, control, setError, clearErrors } =
    useForm<ForgotPasswordZodSchemaFields>({
      defaultValues: {
        email: "",
      },
  ...
  return (
    ...
    >
      <Card
        className={
          "max-w-[378px] mx-auto flex flex-col items-center px-[24px] py-[23px]"
        }
      >
        ...
        <form onSubmit={onSubmit} className={"mt-[37px] !w-330"}>
          ...
          <div className={"relative flex flex-col w-full mt-6 px-7"}>
            ...
            <Recaptcha
              className={
                "flex items-center justify-between relative max-w-full w-full"
              }
